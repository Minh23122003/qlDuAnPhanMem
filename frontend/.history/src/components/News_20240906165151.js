                        ...
                        <Card className="h-100">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    lorem ipsum to show how a filled-out page might look: Excepteur
                                    efficient emerging, minim veniam anim aute carefully curated
                                    Ginza conversation exquisite nostrud nisi intricate Content.
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                        ...
                        <Card className="h-100">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    curated Ginza conversation exquisite nostrud nisi intricate
                                    Content.
                                </Card.Text>
                            </Card.Body>
                        </Card>
