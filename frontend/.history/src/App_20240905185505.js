                ...
                <BrowserRouter>
                    ...
                    <Container>
                        <Routes>
                            ...
                            <Route
                                path="/Relativeparkcard"
                                element={user ? <Relativeparkcard /> : <Navigate to="/login" />}
                            />
                            <Route
                                path="/Notifications"
                            ...
                            <Route
                                ...
                                element={user ? <MerchandiseCabinet /> : <Navigate to="/login" />}
                            />
                            <Route
                                path="/Service"
                            ...
                            <Route
                                path="/ReceiptList"
                                element={user ? <ReceiptList /> : <Navigate to="/login" />}
                            />
                            <Route
                                path="/ChatApp"
